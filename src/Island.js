...
Command: npx gltfjsx@6.1.2 GoodBeach3.glb
*/
...
export function Island(props) {
  ...
  function handleClick(mesh) {
    // You can use a boolean flag to track whether the color is currently red or not
    let isRed = false;
  
    // Add an event listener that will change the color of the mesh when it is clicked
    mesh.addEventListener('click', () => {
      isRed = !isRed;
      mesh.material.color.set(isRed ? 0xff0000 : 0xffffff);
    });
  }
  
  // To use the function, pass in a mesh object as an argument
  const myMesh = new Mesh();
  handleClick(myMesh);
  
  
  // To use the function, you can add an event listener to the mesh
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Vert" position={[1.86, 1.79, -0.08]} rotation={[-0.01, -0.07, -0.02]}>
          ...
          <mesh name="Mesh_1" onClick={handleClick} geometry={nodes.Mesh_1.geometry} material={materials['Material.005']} />
